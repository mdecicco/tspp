...
namespace tspp {
    ...
    struct valid_v8_arg {
            using type = std::conditional_t<
                ...
                std::conditional_t<std::is_same_v<T, i8>, i32, T>>;
    };
    ...
    struct valid_v8_ret {
            using type = std::conditional_t<
                sizeof(T) == 2,
                std::conditional_t<std::is_unsigned_v<T>, u32, i32>,
                std::conditional_t<std::is_same_v<T, i8>, i32, std::conditional_t<std::is_same_v<T, u8>, u32, T>>>;
    };
    ...
    valid_v8_ret_t<T> get_attr(v8::Local<v8::Object> obj, v8::FastApiCallbackOptions& opts) {
        ...
        const bind::DataType::Property* prop =
            (bind::DataType::Property*)opts.data.As<v8::Value>().As<v8::External>()->Value();
    ...
    void destroyObject(const v8::FunctionCallbackInfo<v8::Value>& args) {
        ...
        if (objPtr == (void*)intptr_t(0xdeadbeef)) {
            isolate->ThrowException(
                v8::Exception::Error(v8::String::NewFromUtf8(isolate, "Object already destroyed").ToLocalChecked())
            );
            return;
        }
        ...
        if (!objMgr) {
            isolate->ThrowException(v8::Exception::TypeError(
                v8::String::NewFromUtf8(
                    isolate,
                    String::Format("Host object manager not found for type '%s'", type->getName().c_str()).c_str()
                )
                    .ToLocalChecked()
            ));
            return;
        ...
        // Free memory (this will call the destructor, if one is provided)
        objMgr->free(objPtr);
    ...
    void objectConstructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
        ...
        if (!args.IsConstructCall()) {
            isolate->ThrowException(v8::Exception::TypeError(
                v8::String::NewFromUtf8(isolate, "Constructor cannot be called as a function").ToLocalChecked()
            ));
            return;
        }
        ...
        if (ctors.size() == 0) {
            isolate->ThrowException(v8::Exception::TypeError(
                v8::String::NewFromUtf8(
                    isolate, String::Format("No constructor found for type '%s'", type->getName().c_str()).c_str()
                )
                    .ToLocalChecked()
            ));
            return;
    ...
    void setInternalFields(
        v8::Isolate* isolate, const v8::Local<v8::Object>& obj, void* objPtr, bind::DataType* type, bool isExternal
    ) {
    ...
    void bindProperty(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> proto, const bind::DataType::Property& p) {
        ...
        v8::PropertyAttribute attr =
            p.flags.can_write == 1 ? v8::PropertyAttribute::None : v8::PropertyAttribute::ReadOnly;
        ...
        if (info.is_integral) {
            if (info.is_unsigned) {
                switch (info.size) {
                    case 1:
                        proto->SetAccessorProperty(
                            name, getter<u8>(isolate, off, &p), setter<u8>(isolate, off, &p), attr
                        );
                        break;
                    case 2:
                        proto->SetAccessorProperty(
                            name, getter<u16>(isolate, off, &p), setter<u16>(isolate, off, &p), attr
                        );
                        break;
                    case 4:
                        proto->SetAccessorProperty(
                            name, getter<u32>(isolate, off, &p), setter<u32>(isolate, off, &p), attr
                        );
                        break;
                    case 8:
                        proto->SetAccessorProperty(
                            name, getter<u64>(isolate, off, &p), setter<u64>(isolate, off, &p), attr
                        );
                        break;
                }
            } else {
                switch (info.size) {
                    case 1:
                        proto->SetAccessorProperty(
                            name, getter<i8>(isolate, off, &p), setter<i8>(isolate, off, &p), attr
                        );
                        break;
                    case 2:
                        proto->SetAccessorProperty(
                            name, getter<i16>(isolate, off, &p), setter<i16>(isolate, off, &p), attr
                        );
                        break;
                    case 4:
                        proto->SetAccessorProperty(
                            name, getter<i32>(isolate, off, &p), setter<i32>(isolate, off, &p), attr
                        );
                        break;
                    case 8:
                        proto->SetAccessorProperty(
                            name, getter<i64>(isolate, off, &p), setter<i64>(isolate, off, &p), attr
                        );
                        break;
                }
            }
            ...
            switch (info.size) {
                case 4:
                    proto->SetAccessorProperty(
                        name, getter<f32>(isolate, off, &p), setter<f32>(isolate, off, &p), attr
                    );
                    break;
                case 8:
                    proto->SetAccessorProperty(
                        name, getter<f64>(isolate, off, &p), setter<f64>(isolate, off, &p), attr
                    );
                    break;
            }
        } else {
            proto->SetAccessorProperty(
                ...
                v8::FunctionTemplate::New(
                    isolate, slow_getter, v8::External::New(isolate, const_cast<bind::DataType::Property*>(&p))
                ),
                v8::FunctionTemplate::New(
                    isolate, slow_setter, v8::External::New(isolate, const_cast<bind::DataType::Property*>(&p))
                ),
                attr
            );
        }
    ...
    void bindStaticProperty(
        v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> proto, const bind::DataType::Property& p
    ) {
        v8::Local<v8::String> name = v8::String::NewFromUtf8(isolate, p.name.c_str()).ToLocalChecked();
        v8::PropertyAttribute attr =
            p.flags.can_write == 1 ? v8::PropertyAttribute::None : v8::PropertyAttribute::ReadOnly;
        ...
        if (info.is_integral) {
            if (info.is_unsigned) {
                switch (info.size) {
                    case 1:
                        proto->SetAccessorProperty(
                            name, static_getter<u8>(isolate, &p), static_setter<u8>(isolate, &p), attr
                        );
                        break;
                    case 2:
                        proto->SetAccessorProperty(
                            name, static_getter<u16>(isolate, &p), static_setter<u16>(isolate, &p), attr
                        );
                        break;
                    case 4:
                        proto->SetAccessorProperty(
                            name, static_getter<u32>(isolate, &p), static_setter<u32>(isolate, &p), attr
                        );
                        break;
                    case 8:
                        proto->SetAccessorProperty(
                            name, static_getter<u64>(isolate, &p), static_setter<u64>(isolate, &p), attr
                        );
                        break;
                }
            } else {
                switch (info.size) {
                    case 1:
                        proto->SetAccessorProperty(
                            name, static_getter<i8>(isolate, &p), static_setter<i8>(isolate, &p), attr
                        );
                        break;
                    case 2:
                        proto->SetAccessorProperty(
                            name, static_getter<i16>(isolate, &p), static_setter<i16>(isolate, &p), attr
                        );
                        break;
                    case 4:
                        proto->SetAccessorProperty(
                            name, static_getter<i32>(isolate, &p), static_setter<i32>(isolate, &p), attr
                        );
                        break;
                    case 8:
                        proto->SetAccessorProperty(
                            name, static_getter<i64>(isolate, &p), static_setter<i64>(isolate, &p), attr
                        );
                        break;
                }
            }
            ...
            switch (info.size) {
                case 4:
                    proto->SetAccessorProperty(
                        name, static_getter<f32>(isolate, &p), static_setter<f32>(isolate, &p), attr
                    );
                    break;
                case 8:
                    proto->SetAccessorProperty(
                        name, static_getter<f64>(isolate, &p), static_setter<f64>(isolate, &p), attr
                    );
                    break;
            }
        } else {
            proto->SetAccessorProperty(
                name,
                v8::FunctionTemplate::New(
                    isolate, slow_static_getter, v8::External::New(isolate, const_cast<bind::DataType::Property*>(&p))
                ),
                v8::FunctionTemplate::New(
                    isolate, slow_static_setter, v8::External::New(isolate, const_cast<bind::DataType::Property*>(&p))
                ),
                attr
            );
        }
    ...
    void bindMethod(
        ...
        const bind::DataType::Property& p
    ) {
        ...
        v8::Local<v8::FunctionTemplate> ft = v8::FunctionTemplate::New(
            isolate,
            p.flags.is_static == 1 ? (isAsync ? AsyncFunctionCallProxy : FunctionCallProxy)
                                   : (isAsync ? AsyncMethodCallProxy : MethodCallProxy),
            v8::External::New(
                isolate, p.flags.is_static == 1 ? (void*)func : (void*)const_cast<bind::DataType::Property*>(&p)
            ),
            v8::Local<v8::Signature>(),
            0,
            v8::ConstructorBehavior::kThrow
        ...
        if (p.flags.is_static == 1) {
            ctor->Set(v8::String::NewFromUtf8(isolate, p.name.c_str()).ToLocalChecked(), ft);
        } else {
            proto->Set(v8::String::NewFromUtf8(isolate, p.name.c_str()).ToLocalChecked(), ft);
        }
    }
    ...
    v8::Local<v8::FunctionTemplate> buildPrototype(v8::Isolate* isolate, bind::DataType* type) {
        ...
        v8::Local<v8::FunctionTemplate> ctor =
            v8::FunctionTemplate::New(isolate, objectConstructor, v8::External::New(isolate, type));
        ...
        for (u32 i = 0; i < props.size(); i++) {
            ...
            if (p.offset < 0) {
                if (p.flags.is_ctor == 1 || p.flags.is_dtor == 1) {
                    continue;
                }

                if (p.flags.is_method == 1 || p.flags.is_pseudo_method == 1) {
                    bindMethod(isolate, proto, ctor, p);
                    continue;
                }
