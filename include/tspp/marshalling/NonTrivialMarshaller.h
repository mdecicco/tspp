...
namespace tspp {
    class NonTrivialMarshaller : public IDataMarshaller {
        ...
        protected:
            ...
            v8::Local<v8::Value> convertToV8WithCopy(CallContext& context, void* value, HostObjectManager* objMgr);

            v8::Local<v8::Object> wrapHostObject(CallContext& context, void* value, JavaScriptTypeData* typeData);
    };
}