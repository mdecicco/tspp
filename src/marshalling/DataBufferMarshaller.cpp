...
namespace tspp {
    ...
    v8::Local<v8::Value> DataBufferMarshaller::convertToV8(CallContext& context, void* value, bool valueNeedsCopy) {
    ...
    void* DataBufferMarshaller::convertFromV8(CallContext& callCtx, const v8::Local<v8::Value>& value) {
        ...
        builtin::databuffer::DataBuffer* buffer = new (data) builtin::databuffer::DataBuffer(backingStore->ByteLength());
