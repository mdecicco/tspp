...
namespace tspp {
    v8::Local<v8::Function> createCallback(v8::Isolate* isolate, bind::FunctionType* sig, void* funcPtr) {
        ...
        data->Set(context, v8::String::NewFromUtf8(isolate, "a").ToLocalChecked(), v8::External::New(isolate, sig)).ToChecked();
        data->Set(context, v8::String::NewFromUtf8(isolate, "b").ToLocalChecked(), v8::External::New(isolate, funcPtr)).ToChecked();
    ...
    void CallbackCallProxy(const v8::FunctionCallbackInfo<v8::Value>& args) {
        ...
        v8::Local<v8::Value> sigVal = data->Get(context, v8::String::NewFromUtf8(isolate, "a").ToLocalChecked()).ToLocalChecked();
        v8::Local<v8::Value> funcPtrVal = data->Get(context, v8::String::NewFromUtf8(isolate, "b").ToLocalChecked()).ToLocalChecked();
