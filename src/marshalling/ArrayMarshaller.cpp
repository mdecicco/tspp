...
namespace tspp {
    ...
    bool ArrayMarshaller::canAccept(v8::Isolate* isolate, const v8::Local<v8::Value>& value) {
        ...
        for (u32 i = 0; i < size; i++) {
            if (!elementMarshaller->canAccept(isolate, array->Get(context, i).ToLocalChecked())) {
                return false;
            }
        }
    ...
    v8::Local<v8::Value> ArrayMarshaller::convertToV8(
    ...
    void* ArrayMarshaller::convertFromV8(CallContext& callCtx, const v8::Local<v8::Value>& value) {
        ...
        if (!value->IsArray()) {
            ...
            isolate->ThrowException(
                v8::Exception::TypeError(v8::String::NewFromUtf8(isolate, "Expected an array").ToLocalChecked())
            );
        ...
        for (u32 i = 0; i < size; i++) {
            ...
            elementMarshaller->fromV8(callCtx, array->Get(context, i).ToLocalChecked());
